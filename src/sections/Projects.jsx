    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* Portfolio Project */}
          <div className="group bg-[#f5e6dc] rounded-3xl overflow-hidden border border-[#ead8cc] shadow-md hover:-translate-y-3 hover:shadow-2xl transition-all duration-500">

            <div className="h-56 bg-[#f1d7c9] flex items-center justify-center relative overflow-hidden">

              <div className="absolute w-40 h-40 bg-[#8b4a32]/20 rounded-full -top-16 -right-10 group-hover:scale-150 transition-transform duration-700"></div>
            ...
            <div className="p-8">
              ...
              <span className="inline-block px-3 py-1 rounded-full bg-[#f5e6dc] border border-[#ead8cc] text-[#8b4a32] text-sm font-semibold mb-4">
                React.js
              </span>

              <h3 className="text-2xl font-bold text-[#3b1f14] mb-3">
                Portfolio Website
              </h3>
              ...
              <a
                href="#home"
                className="inline-flex items-center px-6 py-3 rounded-xl bg-[#5a2d1c] text-white font-semibold hover:bg-[#8b4a32] hover:-translate-y-1 hover:shadow-lg transition-all duration-300"
              >
                Explore Portfolio →
              </a>
